...
class Project(Base):
    ...
    project_type: Mapped[str] = mapped_column(String(30), default="ai_generation")
    category: Mapped[str] = mapped_column(String(40), default="generic")
    object_profile: Mapped[str] = mapped_column(String(30), default="auto")
...
class ReconstructionVersion(Base):
    ...
    reconstruction_type: Mapped[str] = mapped_column(String(30), default="ai_generation")
